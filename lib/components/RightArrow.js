...
const RightArrow = props => {
  ...
  const ForwardArrow = _styledComponents.default.div`
    cursor: pointer;
  `;
  const ForwardArrowDisabled = (0, _styledComponents.default)(ForwardArrow)`
    opacity: 0.3;
  `;
  return /*#__PURE__*/_react.default.createElement(ForwardArrow, {
