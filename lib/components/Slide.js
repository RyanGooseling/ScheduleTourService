...
const Slide = props => {
  ...
  const fakeDates = [1, 2, 3, 4, 5]; // all buttons should be defined in every other manner (spacing, etc) and this should only ADD whether it renders or not
  ...
  return /*#__PURE__*/_react.default.createElement("section", null, fakeDates.map(date => {
